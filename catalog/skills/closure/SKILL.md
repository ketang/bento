...
This apply mode deletes only local branches classified as `safe_to_delete`
(merged into primary AND not checked out in any worktree). Everything else
remains review-driven.
