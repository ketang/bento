...
- New issues pass issue-completeness-precheck before `gh issue create` is run.
...
## Auditable Claims
- The SKILL.md states: "Before `gh issue create`, use the `issue-completeness-precheck` skill."
