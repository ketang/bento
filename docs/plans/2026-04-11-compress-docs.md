...
- `plugins/bento/skills/compress-docs/` — generated by `scripts/build-plugins` at the end of the plan, not hand-edited.
...
**Files:**
- Modify: `plugins/bento/skills/compress-docs/` (generated)
...
`plugins/bento/skills/compress-docs/` appears.

- [ ] **Step 2: Verify the skill was copied**

```bash
ls plugins/bento/skills/compress-docs/
```
...
```bash
git add plugins/bento/skills/compress-docs .claude-plugin/marketplace.json
git commit -m "build(plugins): sync compress-docs into bento plugin"
```
